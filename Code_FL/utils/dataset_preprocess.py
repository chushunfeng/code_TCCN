...
class FEMNIST(Dataset):
    ...
    def __init__(self, data_dir='.', train=True, transform=None, target_transform=None, ):
        ...
        train_clients, train_groups, train_data_temp, test_data_temp = read_data(data_dir+'/femnist/train',
...
class ShakeSpeare(Dataset):
    def __init__(self, data_dir='.', train=True):
        ...
        train_clients, train_groups, train_data_temp, test_data_temp = read_data(data_dir+'/shakespeare/train',
